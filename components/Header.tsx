      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="font-display text-xl font-extrabold text-brand-700 group-hover:text-brand-800 transition-colors">
              SmartBudget<span className="text-sunset-500">Air</span>
            </span>
          </Link>
